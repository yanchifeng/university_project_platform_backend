...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String tables = "mentor,project,project_management,student,student_group,user,Competition,credits,project_management_operation,credits_operation,websocket,home_page";
